"""Global hub .env — shared secrets + map to job prefixes (GROK_*, ENTER_*, OUTLOOK_*, GETUNIKEY_*).
...
_SHARED_MAP: dict[str, str] = {
    ...
    "EXZORK_API": "EXZORK_API",
    "EXZORK_API_KEY": "EXZORK_API_KEY",
    "EXZORK_DOMAIN": "EXZORK_DOMAIN",
    "EXZORK_WILDCARD": "EXZORK_WILDCARD",
